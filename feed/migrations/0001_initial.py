    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('exerciseImage', models.ImageField(blank=True, null=True,
                                                    upload_to='exercises/',
                                                    verbose_name='Bilde av '
                                                                 'øvelsen')),
                ('createdBy', models.ForeignKey(blank=True, null=True,
                                                on_delete=django.db.models
                                                .deletion.SET_NULL,
                                                to='profile_page.CreatedBy',
