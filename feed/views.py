...
def select_all_tasks(conn, search_word):
        ...
        cur.execute("SELECT * FROM feed_exercise WHERE exerciseTitle=?", (search_word,))
...
'''
Not in use yet
    tester for bare select_all i første omgang - her går de etter priority som er definert som tall
